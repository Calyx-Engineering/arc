...
| `skills/work-watch` | m14 · m23 · m41 · m13 · m15 · m17 | Commit timing, test obligations, depth, edit completeness, the working surface, friction with Arc itself, the session's own saturation, and a failure about to be blamed on the user's environment — one sweep | Build |
