...
delegation the persona exists to support. Character costs reader attention on every
utterance.

**The register is a value, not code.** Trialling all three during first use and selecting on
evidence costs one diff each.
