...
**The nudge's over-firing budget.** The event half and `work-watch`'s proposing checks share
one threshold, and nothing sets it. First use produces the number. Which checks those are, and
which are exempt because they fire on an act rather than a pause, is
[`work-watch`](../../../skills/work-watch/SKILL.md)'s to say.
