...
| `skills/work-watch` | skill | m14 · m23 · m41 | Always, as work proceeds | `skills/relief-valve` when the depth precondition trips · `skills/issue-write` to file what it catches |
