...
| 22 | 6.2 | [#73](https://github.com/Calyx-Engineering/arc/issues/73) | The autonomy switch — specified and built | **In progress**. Left for *Onboarding — m47* and **returned 2026-08-21** after three to five failed surface fixes. It reclaims its own slot, so nothing renumbers |
