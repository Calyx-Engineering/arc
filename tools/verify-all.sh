...
KNOWN="verify-autonomy verify-skill-registry verify-tracker-body verify-hook verify-template-links verify-close-sequence verify-handoff-checks verify-handoff-rationale verify-handoff-archive verify-workspace-guard verify-linked-branch verify-mechanisms verify-dev-log-name miner-scope skill-firing handoff-openings skill-cases response-length topic-numbering report-grade"
