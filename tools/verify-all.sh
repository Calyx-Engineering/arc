...
KNOWN="verify-autonomy verify-skill-registry verify-tracker-body verify-hook verify-template-links verify-handoff-checks verify-workspace-guard miner-scope skill-firing skill-cases response-length topic-numbering"
