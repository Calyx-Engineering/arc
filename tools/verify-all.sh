...
KNOWN="verify-autonomy verify-skill-registry verify-tracker-body verify-hook verify-template-links verify-close-sequence verify-handoff-checks verify-workspace-guard verify-linked-branch verify-mechanisms miner-scope skill-firing skill-cases response-length topic-numbering report-grade"
